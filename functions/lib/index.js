...
exports.createPortalSession = exports.stripeWebhook = exports.createCheckoutSession = exports.verifyAppleToken = void 0;
...
exports.stripeWebhook = functions.https.onRequest(async (req, res) => {
    ...
    if (event.type === "checkout.session.completed") {
        ...
        await admin.firestore().collection("users").doc(uid).set({ isPro: true, orgId: orgRef.id }, { merge: true });
    }
    res.json({ received: true });
});
